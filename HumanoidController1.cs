...
public class HumanoidController : MonoBehaviour
{
	...
	void Update ()
    {
        ...
        //Extraemos la velocidad del plano XZ
        Vector3 velocity = new Vector3(controller.velocity.magnitude);

        //Modifica los parametros del Animator
        mechanim.SetFloat("Speed", velocity.magnitude);
